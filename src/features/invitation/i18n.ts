...
export interface InvI18n {
  ...
  ceremonyTitle: string;      // "Lễ Thành Hôn"
  receptionTitle: string;     // "Tiệc Cưới"
  welcomeGuests: string;      // "Đón khách"
  ceremonyVenueLabel: string; // "Lễ được cử hành tại"
  // Countdown
  days: string;
  hours: string;
  minutes: string;
...
const vi: InvI18n = {
  ...
  welcomeGuests: 'Đón khách',
  ceremonyVenueLabel: 'Lễ được cử hành tại',
...
const en: InvI18n = {
  ...
  welcomeGuests: 'Welcome',
  ceremonyVenueLabel: 'Ceremony held at',
...
const fr: InvI18n = {
  ...
  welcomeGuests: 'Accueil',
  ceremonyVenueLabel: 'Cérémonie célébrée à',
...
const es: InvI18n = {
  ...
  welcomeGuests: 'Recepción de invitados',
  ceremonyVenueLabel: 'Ceremonia celebrada en',
...
const ar: InvI18n = {
  ...
  banquet: 'بدء الحفل',
  monthLabel: 'الشهر',
  ceremonyTitle: 'مراسم الزواج',
  receptionTitle: 'حفل الاستقبال',
  welcomeGuests: 'استقبال الضيوف',
  ceremonyVenueLabel: 'تُقام المراسم في',
...
const ru: InvI18n = {
  ...
  welcomeGuests: 'Встреча гостей',
  ceremonyVenueLabel: 'Церемония состоится в',
...
const id: InvI18n = {
  ...
  monthLabel: 'BULAN',
  ceremonyTitle: 'Akad / Pemberkatan',
  receptionTitle: 'Resepsi',
  welcomeGuests: 'Penerimaan tamu',
  ceremonyVenueLabel: 'Akad diselenggarakan di',
...
const de: InvI18n = {
  ...
  banquet: 'DINNER',
  monthLabel: 'MONAT',
  ceremonyTitle: 'Trauung',
  receptionTitle: 'Hochzeitsfeier',
  welcomeGuests: 'Empfang',
  ceremonyVenueLabel: 'Trauung findet statt in',
